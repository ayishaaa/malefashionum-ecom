...
function Tag() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${backendUrl}/admin/listtag`);
  ...
  const handleAddTag = (e) => {
    ...
    reader.onloadend = async () => {
      ...
      axios
        .post(`${backendUrl}/admin/addtag`, formData)
        .then((response) => {
  ...
  const handleEditTag = (e) => {
    ...
    if (image) {
      ...
      reader.onloadend = async () => {
        ...
        axios
          .put(`${backendUrl}/admin/edittag/${selectedProduct._id}`, formData)
          .then((response) => {
            console.log(response);
  ...
  const deleteTag = async (id) => {
    try {
      await axios.delete(`${backendUrl}/admin/removetag/${id}`);
