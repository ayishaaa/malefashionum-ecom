...
function Material() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${backendUrl}/admin/listmaterial`);
  ...
  const handleAddMaterial = (e) => {
    ...
    reader.onloadend = async () => {
      ...
      axios
        .post(`${backendUrl}/admin/addmaterial`, formData)
        .then((response) => {
  ...
  const handleEditMaterial = (e) => {
    ...
    if (image) {
      ...
      reader.onloadend = async () => {
        ...
        axios
          .put(`${backendUrl}/admin/editmaterial/${selectedProduct._id}`, formData)
          .then((response) => {
            console.log(response);
  ...
  const deleteMaterial = async (id) => {
    try {
      await axios.delete(`${backendUrl}/admin/removematerial/${id}`);
