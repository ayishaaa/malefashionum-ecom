...
function Brand() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${backendUrl}/admin/listbrand`);
  ...
  const handleAddBrand = (e) => {
    ...
    reader.onloadend = async () => {
      ...
      axios
        .post(`${backendUrl}/admin/addbrand`, formData)
        .then((response) => {
  ...
  const handleEditBrand = (e) => {
    ...
    if (image) {
      ...
      reader.onloadend = async () => {
        ...
        axios
          .put(`${backendUrl}/admin/editbrand/${selectedProduct._id}`, formData)
          .then((response) => {
            console.log(response);
  ...
  const editBrand = (id) => {
    ...
    setBrandName(selectedProduct.Name);
  ...
  const deleteBrand = async (id) => {
    try {
      await axios.delete(`${backendUrl}/admin/removebrand/${id}`);
  ...
  return (
    <DashboardLayout>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle style={{ backgroundColor: "#bd1515", color: "white" }}>Add Brand</DialogTitle>
        <DialogContent>
          <MDBox mb={2}>
            <MDInput
              type="file"
        ...
        <DialogActions>
          ...
          <Button onClick={handleAddBrand} style={{ backgroundColor: "#bd1515", color: "white" }}>
            Add
          </Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={open1} onClose={handleClose1}>
        <DialogTitle style={{ backgroundColor: "#bd1515", color: "white" }}>Edit Brand</DialogTitle>
        <DialogContent>
          <MDBox mb={2}>
            <MDInput
              type="file"
        ...
        <DialogActions>
          ...
          <Button onClick={handleEditBrand} style={{ backgroundColor: "#bd1515", color: "white" }}>
            Edit
          </Button>
        </DialogActions>
      </Dialog>
