...
function Category() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`${backendUrl}/admin/listcategory`);
  ...
  const handleAddCategory = (e) => {
    ...
    reader.onloadend = async () => {
      ...
      axios
        .post(`${backendUrl}/admin/addcategory`, formData)
        .then((response) => {
  ...
  const handleEditCategory = (e) => {
    ...
    if (image) {
      ...
      reader.onloadend = async () => {
        ...
        axios
          .put(`${backendUrl}/admin/editcategory/${selectedProduct._id}`, formData)
          .then((response) => {
            console.log(response);
  ...
  const deleteCategory = async (id) => {
    try {
      await axios.delete(`${backendUrl}/admin/removecategory/${id}`);
